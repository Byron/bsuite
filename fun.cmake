...
function(add_maya_project)
	...
	foreach(MAYA_VERSION IN LISTS PROJECT_MAYA_VERSIONS)
		...
		if(NOT EXISTS ${_MAYA_LOCATION})
			message(WARNING "maya was not found at ${_MAYA_LOCATION} - please assure your MAYA_VERSIONS are set correctly. Otherwise set the ${MAYA_LOCATION_VAR} variable.")
		else()
			# MAYA INCLUDE DIR 
		...
		endif()# end if devkit location exists
